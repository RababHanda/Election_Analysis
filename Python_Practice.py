...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        # If the candidate doesn't match any existing candidate add it to the candidate list
        ...
        ## 4a: Write an if statement that checks the county doesn't match any existing county in the county list.
